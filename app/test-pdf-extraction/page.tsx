...
export default function TestPdfExtraction() {
  // Define all states but initialize most of them only after component mounts
  ...
  // This ensures hydration consistency by only rendering certain elements on the client
  useEffect(() => {
    setIsClient(true);
  }, []);
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      {errorMessage && !apiKeyMissing && isClient && (
        <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded mb-6">
          {errorMessage}
        </div>
      )}
      
      {characterCount > 0 && isClient && (
