...
/* harmony export */   polyfillPath2D: () => (/* binding */ polyfillPath2D),
/* harmony export */   polyfillRoundRect: () => (/* binding */ polyfillRoundRect)
/* harmony export */ });
/******************************************************************************
 ...
 */ function parsePath(path) {
    ...
    p.replace(SEGMENT_PATTERN, function(_, command, args) {
        ...
        if (type === "m" && theArgs.length > 2) {
            data.push(__spreadArray([
                theCommand
            ], theArgs.splice(0, 2), true));
            type = "l";
        ...
        data.push(__spreadArray([
            theCommand
        ], theArgs.splice(0, ARG_LENGTH[type]), true));
 ...
 */ function polyfillPath2D(window) {
    ...
    /* eslint-disable @typescript-eslint/unbound-method */ // setting unbound functions here. Make sure this is set in function call later
    ...
    /* eslint-enable @typescript-eslint/unbound-method */ CanvasRenderingContext2D.prototype.fill = function fill() {
        var args = [];
