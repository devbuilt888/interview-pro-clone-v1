...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ camelcaseKeys)
});

;// CONCATENATED MODULE: ./node_modules/map-obj/index.js
...
;// CONCATENATED MODULE: ./node_modules/camelcase-keys/index.js
...
const camelcase_keys_isObject = (value)=>typeof value === "object" && value !== null && !(value instanceof RegExp) && !(value instanceof Error) && !(value instanceof Date);
const transform = (input, options = {})=>{
    if (!camelcase_keys_isObject(input)) {
        return input;
    }
    const { exclude, pascalCase = false, stopPaths, deep = false, preserveConsecutiveUppercase = false } = options;
    const stopPathsSet = new Set(stopPaths);
    const makeMapper = (parentPath)=>(key, value)=>{
            if (deep && camelcase_keys_isObject(value)) {
